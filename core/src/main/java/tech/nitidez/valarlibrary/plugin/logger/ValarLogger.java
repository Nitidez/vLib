package tech.nitidez.valarlibrary.plugin.logger;
...
public class ValarLogger extends PluginLogger {
  
  private final Plugin plugin;
  private final String prefix;
  private final CommandSender sender;
  
  public ValarLogger(Plugin plugin) {
    super(plugin);
    this.plugin = plugin;
  ...
  public ValarLogger(ValarLogger parent, String prefix) {
    super(parent.plugin);
  ...
  public ValarLogger getModule(String module) {
    return new ValarLogger(this, module + ": ");
  }
